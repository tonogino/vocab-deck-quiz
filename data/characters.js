const CHARACTERS = {
  sophia: {
    ...
    lines: {
      ...
      wrong: ["没关系，再看一眼答案就好了。", "错了也没事。比起逃避，继续学才更重要。", "我不会因为你答错就讨厌你的啦。"],
      reveal: ["答案就在这里。下次要自己想起来哦。", "偷看答案也可以，不过之后要补回来。", "记不住的时候，先理解意思也很好。"],
      click: ["怎么了？想休息一下吗？", "你一直看着我，是想让我夸你吗？", "别偷懒啦，先把这个单词背完。", "如果你今天认真学习，我会很开心的。"],
      highAffection: ["和你一起学习，好像也没有那么无聊。", "今天也来找我了啊……我有点高兴。", "别太勉强自己。我会一直在这里。"]
    }
  }
};
